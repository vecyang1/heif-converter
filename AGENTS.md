...
- **Changelog & Evolution Accounting**: Remember to update `CHANGELOG.md` whenever features, bug fixes, or operational contracts change, so users and future agents understand how things and features evolved along the timeline. Transient debugging stays in `progress.md`.
